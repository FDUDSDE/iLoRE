...
def eval_edge_prediction(model, negative_edge_sampler, data, n_neighbors, \
                         batch_size=200, mini_batch_size=50):
  ...
  with torch.no_grad():
    ...
    for k in range(num_test_batch):
      ...
      pos_prob, neg_prob, _, _ = model.compute_edge_probabilities(sources_batch, destinations_batch,
                                                            ...
                                                            edge_idxs_batch, k, n_neighbors, mini_batch_size)
...
def eval_node_classification(tgn, decoder, data, edge_idxs, batch_size, n_neighbors, mini_batch_size):
