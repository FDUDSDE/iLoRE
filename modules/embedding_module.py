...
class EmbeddingModule(nn.Module):
  def __init__(self, node_features, edge_features, memory, neighbor_finder, time_encoder, count_encoder, n_layers,
               n_node_features, n_edge_features, n_time_features, n_count_features, embedding_dimension, device,
               dropout):
    ...
    self.n_count_features = n_count_features
...
class GraphEmbedding(EmbeddingModule):
  def __init__(self, node_features, edge_features, memory, neighbor_finder, time_encoder, count_encoder, n_layers,
    ...
    super(GraphEmbedding, self).__init__(node_features, edge_features, memory,
                                         neighbor_finder, time_encoder, count_encoder, n_layers,
                                         n_node_features, n_edge_features, n_time_features, n_count_features,
                                         embedding_dimension, device, dropout)
  ...
  def compute_embedding(self, memory, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
    ...
    if n_layers == 0:
      ...
      neighbors, edge_idxs, edge_times, neighbor_counts = self.neighbor_finder.get_temporal_neighbor(
        source_nodes,
        timestamps,
      ...
      neighbor_counts_torch = torch.from_numpy(neighbor_counts).float().to(self.device)
      ...
      count_embeddings = self.count_encoder(neighbor_counts_torch)
  ...
  def aggregate(self, n_layers, source_node_features, source_nodes_time_embedding,
                neighbor_embeddings,
                edge_time_embeddings, count_embeddings, edge_features, mask):
    return None
...
class GraphAttentionEmbedding(GraphEmbedding):
  def __init__(self, node_features, edge_features, memory, neighbor_finder, time_encoder,count_encoder, n_layers,
    ...
    super(GraphAttentionEmbedding, self).__init__(node_features, edge_features, memory,
                                                  ...
                                                  n_time_features, n_count_features,
...
def get_embedding_module(module_type, node_features, edge_features, memory, neighbor_finder,
                         time_encoder,count_encoder, n_layers, n_node_features, n_edge_features, n_time_features,
                         n_count_features,
                         embedding_dimension, device,
  ...
  if module_type == "graph_attention":
    return GraphAttentionEmbedding(node_features=node_features,
                                    ...
                                    count_encoder=count_encoder,
                                    n_layers=n_layers,
                                    n_node_features=n_node_features,
                                    n_edge_features=n_edge_features,
                                    n_time_features=n_time_features,
                                    n_count_features=n_count_features,
                                    embedding_dimension=embedding_dimension,
                                    device=device,
